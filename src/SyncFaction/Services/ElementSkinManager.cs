...
public class ElementSkinManager
{
    ...
    /// <summary>
    ///     <para>
    ///     Change the <see cref="FrameworkElement" />'s <see cref="ResourceDictionary" />'s <see cref="ResourceDictionary.Source" /> between the light and dark URIs which were set by
    ///     <see cref="RegisterSkins" />.
    ///     </para>
    ///     <para>
    ///     This is called once by <see cref="RegisterSkins" />, and again anytime you want to switch between themes for the control.
    ///     </para>
    /// </summary>
    /// <param name="isDarkTheme">
    /// <see langword="true" /> to set dark theme, or <see langword="false" /> to set light theme.
    /// </param>
    public virtual void UpdateTheme(bool isDarkTheme)
    {
        if (_skinResources != null)
        {
            _skinResources.Source = isDarkTheme
                ? _darkThemeResources
                : _lightThemeResources;
        }
    }
    ...
    /// </summary>
    /// <param name="theme">
    /// <see cref="Theme.Dark" /> to set dark theme, <see cref="Theme.Light" /> to set light theme, or <see cref="Theme.Auto" /> to set current process theme
    /// </param>
